...
M.dap = {
  {
    '<F5>',
    '<cmd>GodotRunProject<cr>',
    desc = 'Godot: Run Project',
  },
  {
    '<F6>',
    '<cmd>GodotRunCurrentScene<cr>',
    desc = 'Godot: Run Current Scene',
  },
  {
    '<leader>gd',
    '<cmd>GodotDocs<cr>',
    desc = 'Godot: Class Documentation',
  },
  {
    '<leader>gh',
    vim.lsp.buf.hover,
    desc = 'Godot: Method Hover (LSP)',
  },
  {
    '<F10>',
    function()
...
M.opencode = {
  ...
  { "+", "<C-a>", mode = "n", desc = "Increment under cursor", remap = false },
  { "-", "<C-x>", mode = "n", desc = "Decrement under cursor", remap = false },
}
